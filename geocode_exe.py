...
class GeocodeApp(tk.Tk):
    ...
    def _build_landing_tab(self, root: tk.Widget) -> None:
        ...
        self._block_widget_mousewheel(self.landing_wkt_combo)
        ...
        self._block_widget_mousewheel(self.landing_lon_combo)
        ...
        self._block_widget_mousewheel(self.landing_lat_combo)
        ...
        self._block_widget_mousewheel(self.landing_territory_combo)
        ...
        self._block_widget_mousewheel(self.landing_buffer_spinbox)
